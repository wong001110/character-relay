...
| Knowledge Fabric scope/content/interpretation/query/context | `persistence/knowledge_fabric_*`, `knowledge_fabric_policy.py`, `knowledge_fabric_ingestion*.py`, `knowledge_fabric_interpretation_policy.py`, `knowledge_fabric_query*.py`, `knowledge_fabric_context.py`, `knowledge_fabric_epistemic_policy.py`, `knowledge_object_storage.py`, `api/routes/knowledge_fabric.py` | `tests/test_knowledge_fabric_phase2.py` through `test_knowledge_fabric_phase5.py`, `test_knowledge_fabric_epistemic_policy.py`, `test_character_turn_context_v3.py`, PostgreSQL foundation tests | `docs/knowledge-fabric-architecture.md`, active Phase 6 plan |
| Legacy Knowledge, RAG, Wiki / later Projection | `knowledge_*`, `server_knowledge_v3_repository.py`, `internal_context.py`, `knowledge_consolidation_v3.py` | knowledge/wiki/context tests | `docs/context-rag-v1.md`, Knowledge Fabric Phase 7 plan |
