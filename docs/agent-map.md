...
| Knowledge Fabric scope/content/interpretation | `persistence/knowledge_fabric_*`, `knowledge_fabric_policy.py`, `knowledge_fabric_ingestion*.py`, `knowledge_fabric_interpretation_policy.py`, `knowledge_object_storage.py`, `api/routes/knowledge_fabric.py` | `tests/test_knowledge_fabric_phase2.py`, `tests/test_knowledge_fabric_phase3.py`, `tests/test_knowledge_fabric_phase4.py`, focused Knowledge Fabric policy tests | `docs/knowledge-fabric-architecture.md`, active Phase 4 plan |
