...
| Knowledge Fabric scope/content/interpretation/query/context/projection/adapters | `persistence/knowledge_fabric_*`, `knowledge_fabric_projection_policy.py`, `knowledge_fabric_ingestion*.py`, `knowledge_fabric_document_adapter.py`, `knowledge_fabric_document_policy.py`, `knowledge_fabric_git_adapter.py`, `knowledge_fabric_git_policy.py`, `knowledge_fabric_external_policy.py`, `knowledge_fabric_website_adapter.py`, `knowledge_fabric_website_sync.py`, `knowledge_fabric_interpretation_policy.py`, `knowledge_fabric_query*.py`, `knowledge_fabric_context.py`, `knowledge_fabric_epistemic_policy.py`, `knowledge_object_storage.py`, `api/routes/knowledge_fabric.py` | `tests/test_knowledge_fabric_phase2.py` through `test_knowledge_fabric_phase5.py`, `test_knowledge_fabric_projection.py`, `test_knowledge_fabric_document_adapter.py`, `test_knowledge_fabric_git_adapter.py`, `test_knowledge_fabric_website_sync.py`, `test_knowledge_fabric_epistemic_policy.py`, `test_internal_context_knowledge_search.py`, `test_character_turn_context_v3.py`, PostgreSQL foundation tests | `docs/knowledge-fabric-architecture.md`, active Phase 9 plan |
